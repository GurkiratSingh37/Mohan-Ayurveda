        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start mb-12">
            ...
            <div className="w-full md:w-1/2 md:pl-8">
              <h3 className="text-xl font-serif font-medium mb-6 text-amber-200 text-left sm:text-right md:text-left">
                Contact Us
              </h3>
              <ul className="space-y-4">
                <li className="flex items-start sm:items-center sm:justify-end md:justify-start">
                  <span className="text-sm sm:text-base">620 Nine Mile Dr, Bedford, NS</span>
                  <MapPin className="h-5 w-5 text-amber-300 ml-3 flex-shrink-0 mt-0.5 sm:mt-0" />
                </li>
                <li className="flex items-center sm:justify-end md:justify-start">
                  <a href="mailto:harihar190.hm@gmail.com" className="text-sm sm:text-base hover:text-amber-200 transition-colors">
                    harihar190.hm@gmail.com
                  </a>
                  <Mail className="h-5 w-5 text-amber-300 ml-3 flex-shrink-0" />
                </li>
                <li className="flex items-center sm:justify-end md:justify-start">
                  <a href="tel:+11234567890" className="text-sm sm:text-base hover:text-amber-200 transition-colors">
                    +1 (123) 456-7890
                  </a>
            ...
            <div className="flex space-x-4 sm:space-x-6 mb-6">
              {[
                ...
                <a 
                  key={index}
                  href={social.url}
                  className="h-9 w-9 sm:h-10 sm:w-10 rounded-full bg-teal-600/30 hover:bg-amber-400/10 flex items-center justify-center text-teal-100 hover:text-amber-300 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
